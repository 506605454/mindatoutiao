...
//		localSlidingMenu.setSecondaryMenu(R.layout.profile_drawer_right); //右边栏
//		localSlidingMenu.setSecondaryShadowDrawable(R.drawable.shadowright);//右边栏设置阴影图片
